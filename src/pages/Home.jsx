      ...
      <main>
        <section className="hero">
          <div className="hero-content">
            ...
            <p>We help you find the perfect property in your ideal location.</p>
            <Link to="/listing" className="cta-button">Browse Listings</Link>
          </div>
        </section>
